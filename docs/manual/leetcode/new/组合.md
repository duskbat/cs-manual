...
public class Solution {
    ...
    public List<String> letterCombinations(String digits) {
        ...
        backtracking(res, sb, digits);
        return res;
    }

    private void backtracking(List<String> res, StringBuilder sb, final String digits) {
...
class Solution {
    ...
    public List<List<Integer>> permuteUnique(int[] nums) {
        ...
        backtracking(0, new Integer[nums.length]);
        return res;
    }

    private void backtracking(int idx, Integer[] output) {
        if (idx == nums.length) {
